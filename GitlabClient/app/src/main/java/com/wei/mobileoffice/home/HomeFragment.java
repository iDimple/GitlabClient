...
import com.wei.mobileoffice.myClass.MyclassActivity;
import com.wei.mobileoffice.exam.ExamActivity;
import com.wei.mobileoffice.assignment.TeacherAssignActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.tab_customer_img:
                intent = new Intent(this.getActivity(), MyclassActivity.class);
                startActivity(intent);
                break;
            ...
            case R.id.tab_product_img:
                intent = new Intent(this.getActivity(), TeacherAssignActivity.class);
                startActivity(intent);
                break;
        }
    }
