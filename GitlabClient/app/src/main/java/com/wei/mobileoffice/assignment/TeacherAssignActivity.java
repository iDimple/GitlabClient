...
public class TeacherAssignActivity extends FragmentActivity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    private class VideoPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (fragment == null) {
                switch (position) {
                    case 0:
                        fragment = new TeacherAssignFragment();
                        break;
                    default:
                        fragment = new TeacherAssignFragment();
                        break;
