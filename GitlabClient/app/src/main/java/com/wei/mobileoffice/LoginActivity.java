...
import static com.wei.mobileoffice.R.id.password;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            j.addProperty("username", mEmail);
            j.addProperty("password", mPassword);
            if (postJson(j.toString())) {
                return true;
            }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                if (jsonTovo(result)) {//老师
                    //登陆成功跳转
                    System.out.println("跳转老师");
                    Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                    intent.putExtra("login", result);
                    LoginActivity.this.startActivity(intent);
                    CacheUtils.putString(LoginActivity.this,"login",result);
                } else {
                    System.out.println("跳转");
                    Intent intent = new Intent(LoginActivity.this, StudentMainActivity.class);
                    intent.putExtra("StudentInfo", result);
                    startActivity(intent);
                    CacheUtils.putString(LoginActivity.this,"Studentlogin",result);
                }
            } else {
